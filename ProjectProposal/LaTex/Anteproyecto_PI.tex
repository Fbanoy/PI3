...
\begin{center}
  \begin{tabular}{c}
    \includegraphics[width=0.30\textwidth]{figures/logo-eafit.png}
  \end{tabular}
\end{center}
...
\vspace*{1cm}
\centerline{\LARGE Student\footnotemark}  
\footnotetext{Student information (\textcolor{red}{email})}
\vfill

\begin{center}
Advisor(s): \\
Advisor 1\footnote{Affiliation, \textcolor{red}{email}}   \\
Advisor 2\footnote{Affiliation, \textcolor{red}{email}}  
\end{center}
...
\begin{center}
  \large
    Research practice (\textcolor{red}{1, 2, 3}) \\
  Research proposal \\
...
\section{Introduction (\textcolor{red}{3 a 4 párrafos})}
...
max‐p‐regions problem. Journal of Regional Science, 52(3), 397-419.
 ...
 \begin{center}
  \begin{tabular}{c}
    \includegraphics[width=0.70\textwidth]{figures/problem_statement}
  \end{tabular}
\end{center}
...
\textcolor{red}{\emph{Student Name}} and \textcolor{red}{\emph{Tutor Name}}.\\
